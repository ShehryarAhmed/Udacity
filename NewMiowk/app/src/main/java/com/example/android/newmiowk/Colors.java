...
public class Colors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent ii = getIntent();
            String s = ii.getStringExtra(KEY_COLORS);
            setTitle(s);
            ...
            final AdapterView adapterView = new AdapterView(this, arrayList, R.color.color_colors);
            ...
            listView.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(android.widget.AdapterView<?> parent, View view, int position, long id) {
                    Toast.makeText(Colors.this,adapterView.getItem(position).toString(),Toast.LENGTH_SHORT).show();
                }
            });
